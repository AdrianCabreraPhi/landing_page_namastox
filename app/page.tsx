  ...
  return (
    <>
      ...
      >
        ...
        >
          <motion.span initial={{ y: -100, opacity: 0 }} transition={{ duration: 0.3 }} animate={{ y: 0, opacity: 100 }} className="text-6xl flex flex-row md:text-9xl text-transparent bg-clip-text bg-gradient-to-r from-[#4E4384] to-[#CE5D69] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)]">
            Namastox
          </motion.span>
          <motion.span transition={{ delay: 0.6, duration: 0.7 }} initial={{ opacity: 0 }} animate={{ opacity: 100 }} className="text-[#7E7E7E] w-full text-center ">
          ...
          <div className="flex flex-row items-center gap-4 mb-[20vh]">
            <motion.a
              ...
              initial={{ opacity: 0, y: 50, x: -50 }} animate={{ opacity: 100, y: 0, x: 0 }}
      ...
      initial={{
        opacity: 0,
        y: 75,
        boxShadow: "0px 0px 0px rgba(78,67,132,0)"
      }}
      animate={{
        opacity: 1,
        y: 0,
        boxShadow: [
          "0px 0px 0px rgba(78,67,132,0)",
          "0px 20px 30px rgba(78, 67, 132, 0.6)",
          "0px 0px 0px rgba(78,67,132,0)"
        ]
      }}
      transition={{
        ...
        // Transición específica para boxShadow (pulso infinito)
        boxShadow: {
          delay: 2,
          duration: 3,
          repeat: Infinity,
          ...
          ease: "easeInOut"
            ...
            className="w-[1400px]   rounded shadow-2xl shadow-[#4E4384]"
            autoPlay
            muted
            loop
          >
